...
git_clone ezahr AZ_ACI_waardepapieren-demo_westeurope_azurecontainer_io 
git_clone ezahr chromebook_galliumOS 
git_clone ezahr commonground 
git_clone ezahr devops 
git_clone ezahr DigitalOcean 
git_clone ezahr huys 
git_clone ezahr julia 
git_clone ezahr k8s-repo 
git_clone ezahr OCI 
git_clone ezahr Waardepapieren-AZURE-ACI 
#git_clone ezahr fail-fast-and-cheap 
git_clone ezahr MobileIron template 
...
git_clone boschpeter AZ_ACI_waardepapieren-demo_westeurope_azurecontainer_io 
git_clone boschpeter AZ_VM_waardepapieren-demo_westeurope_cloudapp_azure_com 
git_clone boschpeter dama-dmbok 
git_clone boschpeter DIGITALOCEAN-KUBERNETES 
git_clone boschpeter fail-fast-and-cheap 
git_clone boschpeter focal-fossa 
git_clone boschpeter go 
git_clone boschpeter HAPROXY-KUBERNETES 
git_clone boschpeter hello-kubernetes 
git_clone boschpeter julia_klasje 
git_clone boschpeter MOOC_UNIC 
git_clone boschpeter msc 
git_clone boschpeter my-simple-pipeline 
git_clone boschpeter mysql 
git_clone boschpeter OCI 
git_clone boschpeter provisioning 
git_clone boschpeter proxmox 
git_clone boschpeter raspberry 
git_clone boschpeter socialcoin-api 
git_clone boschpeter SocialcoinCity 
git_clone boschpeter student-notes 
git_clone boschpeter Tijd-in-de-database 
git_clone boschpeter UNIC 
git_clone boschpeter VaccinatieApp 
git_clone boschpeter vagrant 
git_clone boschpeter waardepapieren 
git_clone boschpeter Waardepapieren-AZURE-ACI 
git_clone boschpeter MCC-repo 
git_clone boschpeter LPC-repo 
git_clone boschpeter Kubernetes 
git_clone boschpeter nextcloud 
git_clone boschpeter docker 
git_clone boschpeter flint 
git_clone boschpeter 2B 
git_clone boschpeter datakluis-repo 
git_clone boschpeter IAM 
git_clone boschpeter julia 
git_clone boschpeter letsencrypt 
git_clone boschpeter sudoku 
git_clone boschpeter Advanced-Data-Modeling-Challenges-DMZ-Europe-2019 
git_clone boschpeter VON 
git_clone boschpeter datavault_alliance 
git_clone boschpeter Threat-Modeling 
git_clone boschpeter LeSS_Large_Scale_Scrum 
git_clone boschpeter SocialCoinChain 
git_clone boschpeter irma_api_server 
git_clone boschpeter uport-react 
git_clone boschpeter powerdesigner 
}
